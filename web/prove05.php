  ...
  <div class="header"><a href="#"><img src="" alt="LogoPlaceholder" name="Insert_logo" width="180" height="90" id="Insert_logo" style="background-color: #C6D580; display:block;" /></a>
    ...
    <p></p>
  	...
  	<?php
		...
		$statement = $db->query('SELECT DISTINCT topic, username, t.threadnumber FROM threads AS t JOIN posts AS p ON t.threadnumber = p.threadnumber JOIN accounts AS a ON a.accountnumber = p.accountnumber');
